...
<div id="auction" class="widget" data-delay="${delayMilis}">
	<div class="widget-head">
		...
		<span class="pull-right">
			<span id="auction-refresh-tip" class="muted"><spring:message code="dashboard.running.refresh.tip" arguments="${delayMins}"/>&nbsp;&nbsp;</span>
